  ...
  <section className={styles.container}>
    <div className={styles.leftDecoration}>
      <div className={styles.leftDecorationImage1}>
        <Image src="/images/decoration1.jpeg" alt="" width="422" height="422" />
      </div>
      <div className={styles.leftDecorationImage2}>
        <Image src="/images/decoration2.jpeg" alt="" width="340" height="256" />
      </div>
      <div className={styles.leftDecorationImage3}>
        <Image src="/images/decoration3.jpeg" alt="" width="325" height="325" />
      </div>
    </div>
    ...
    <div className={styles.rightDecoration}>
      <Image src="/images/decoration4.jpeg" alt="" width="262" height="349" />
    </div>
  </section>
);
